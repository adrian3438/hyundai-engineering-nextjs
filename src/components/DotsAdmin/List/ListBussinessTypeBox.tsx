...
export default function ListBussinessTypeBox ({bussinessTypeId} : Props) {
    ...
    function Change (e:React.ChangeEvent<HTMLSelectElement>) {
        ...
        newParams.set('bussinessType', e.target.value)
    ...
    return(
        ...
        <div className="selectBox">
            <select onChange={(e)=>Change(e)} value={bussinessTypeId} name="" id="">
                <option value="0">전체 사업영역</option>
                {bussinessType?.map((list:any, index:number)=>(
