      ...
      <div id="offcanvas-nav" data-bs-scroll="true" className="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
        ...
        <div className="offcanvas-body ms-lg-auto d-flex flex-column h-100">
          <ul className="navbar-nav">
            ...
            <li className="nav-item dropdown"><a href="/certification" className="nav-link">인증현황</a></li>
            <li className="nav-item dropdown"><a href="/esg" className="nav-link">지속가능경영</a></li>
            <li className="nav-item dropdown"><a href="/inquiry" className="nav-link">문의하기</a></li>
          </ul>
        </div>
      </div>
