                    ...
                    <div className="col-md-10 m-auto">
                        ...
                        <div className="row justify-content-between align-items-center fs-20">
                            <div className="col-md-5">
                                <p><span className="text-primary fw-bold">제2조(정의)</span><br/><span className="fs-15">①</span>이 영에서 사용하는 용어의 정의는 다음과 같다.<br/>lt;개정 1988ㆍ2ㆍ24&gt;</p>
                            ...
                            <div className="col-md-6 text-center">
                                ...
                                <p className="mb-0 fs-20 fw-bold text-navy convert-text01">기존 건물</p>
                            </div>
                        </div>
                        <hr/>
                        <div className="row justify-content-between align-items-center fs-20">
                            <div className="col-md-6 text-center">
                                ...
                                <p className="mb-0 fs-20 fw-bold text-navy convert-text02">건물이 있는 대지<br/><span className="fs-18 fw-normal">A: 기존 건물,  B: 기존 건물</span></p>
                            </div>
                            <div className="col-md-5">
