            ...
            <div className="container py-17">
                <div className="row">
                    <div className="col-md-10 m-auto">
                        <div className="mb-15">
                            <h1><span className="text-primary">증·개축</span></h1>
                        </div>
                        <div className="border rounded px-10 py-10 position-relative">
                            <span className="clip-background">증·개축</span>
                            <p>공장 증축 및 개축은 기존 건축물의 공간과 기능을 확장하여 그 활용도를 높여주고, 저렴한 비용으로 다양한 용도로의 변형 사용이 가능한 고효율 공사 방식입니다. 특히, 이러한 프로젝트는 제한된 건축물의 공간 활용도를 극대화 시켜 기존의 공간을 이용한 사업증대가 가능합니다.</p>
                            <p>당사는 수많은 상업용, 산업용 건물들의 증축과 개축 프로젝트를 담당해왔고, 고객의 다양한 요구에 맞는 형태의 서비스를 제공해 왔습니다. 또한, 고객의 기대를 충족시키기 위해 최선의 기술력으로 보답해왔습니다.</p>
                            <p className="mb-0">증축 및 개축은 철제 파이프, H빔 등을 활용하여 공장복층, 공장증축, 공장옥상증축, 공장2층증축, 사무실준2층, 가설건축물 등의 다양한 형태로의 시공이 가능합니다.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="col-md-10 m-auto">
                        ...
                        <div className="row justify-content-between align-items-center">
                            ...
                            <div className="col-md-6 text-center">
                                <img src="/img/hyundai/business-area/expandBuilding-2.png" alt="건축면적ㆍ연면적, 높이 증가"/>
                                <p className="mb-0 fs-20 fw-bold text-navy">건축면적ㆍ연면적, 높이 증가</p>
                            </div>
                        </div>
                        <hr/>
                        <div className="row justify-content-between align-items-center">
                            <div className="col-md-6 text-center">
                                <img src="/img/hyundai/business-area/expandBuilding-3.png" alt="건물이 있는 대지"/>
                                <p className="mb-0 fs-20 fw-bold text-navy">건물이 있는 대지<br/><span className="fs-16">A: 기존 건물,  B: 기존 건물</span></p>
                            </div>
                            <div className="col-md-5">
                                <p><span className="text-primary fw-bold">제2조(정의)</span><br/><span className="fs-11">①</span>이 영에서 사용하는 용어의 정의는 다음과 같다.&lt;개정 1988ㆍ2ㆍ24&gt;</p>
                        ...
                        <div className="row justify-content-between align-items-center">
                            <div className="col-md-6 text-center">
                                <img src="/img/hyundai/business-area/expandBuilding-4.png" alt="신축"/>
                                <p className="mb-0 fs-20 fw-bold text-navy">건축면적ㆍ연면적, 높이 증가<br/><span className="fs-16">A: 내력벽, 기둥, 보 제거,  B: 기존 건물: 전부 제거</span></p>
                            </div>
                            <div className="col-md-5">
                                <p><span className="text-primary fw-bold">제2조(정의)</span><br/><span className="fs-11">①</span>이 영에서 사용하는 용어의 정의는 다음과 같다.&lt;개정 1988ㆍ2ㆍ24&gt;</p>
                                <p>2. "증축"이라 함은 기존건축물이 있는 대지안에서 건축물의 건축면적ㆍ연면적 또는 높이를 증가시키는 것을 말한다.</p>
