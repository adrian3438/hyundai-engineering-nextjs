                ...
                <div className="row">
                    <div className="col-md-10 m-auto">
                        ...
                        <div className="border rounded px-10 py-15 position-relative fs-19">
                            ...
                            <p className="text-end mt-15"><Image src="/img/hyundai/logo.png" alt="현대 엔지니어링" width={200} height={38} className="h-auto" /> <Image src="/img/hyundai/company/sign.png" alt="이우용" width={200} height={30} className="h-auto"/></p>
                            <p className="text-end display-5">(주)현대엔지니어링 대표 이우용</p>
                        </div>
                    </div>
                </div>
            </div>
